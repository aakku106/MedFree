...
const rupandehiServices = [
  // MANIGRAM, RUPANDEHI (3-4 services)
  {
    ...
    description: "Comprehensive health screening including blood pressure, diabetes, and basic health checkup.",
    category: "General Health",
    diagnosisType: "Health Screening",
    about: "A comprehensive health camp organized by the local health post in Manigram, Rupandehi. This camp offers free health screenings for common conditions including hypertension, diabetes, and general wellness checks. Experienced medical staff will be available to provide consultations and basic medications. This initiative aims to improve healthcare accessibility in rural areas and promote preventive healthcare practices among the community.",
    checks: ["Blood Pressure Check", "Blood Sugar Test", "BMI Calculation", "General Physical Examination"],
    requirements: "Must bring a valid government ID. Children under 12 must be accompanied by a guardian.",
    serviceDetails: {
  ...
  },
  {
    ...
    description: "Free routine vaccinations for children aged 0-5 years including measles, polio, and DPT.",
    category: "Vaccination",
    diagnosisType: "Immunization",
    about: "The Manigram Municipal Health Office is organizing a special vaccination drive for children in the community. All routine childhood vaccinations will be available free of charge, including BCG, DPT, Polio, Measles, and Hepatitis B vaccines. Parents are encouraged to bring their child's immunization card for record keeping. This program is part of the national immunization initiative to ensure every child receives proper protection against preventable diseases.",
    checks: ["Weight Measurement", "Height Measurement", "Temperature Check", "Vaccination Administration"],
    requirements: "Child's birth certificate or citizenship, previous vaccination card (if available), parent/guardian must accompany.",
    serviceDetails: {
  ...
  },
  {
    ...
    about: "Join us for a comprehensive diabetes awareness and screening program in Manigram. This camp aims to identify early signs of diabetes and pre-diabetes conditions in the community. Participants will receive free blood sugar testing (both fasting and random), HbA1c testing for diagnosed patients, and detailed consultations with healthcare professionals. Dietary counseling and lifestyle modification advice will be provided to all attendees.",
    checks: ["Fasting Blood Sugar", "Random Blood Sugar", "HbA1c Test", "Blood Pressure", "BMI Assessment"],
    requirements: "Adults aged 30 and above. Fasting for 8 hours recommended for accurate results.",
    serviceDetails: {
      nepaliDate: "2082-08-25",
      time: "7:00 AM - 2:00 PM",
      location: {
        address: "Manigram Community Hall, Near Main Chowk, Manigram, Rupandehi",
        type: "Point",
  ...
  // SHANKARNAGAR, RUPANDEHI (3-4 services)
  {
    ...
    description: "Comprehensive eye examination and free eyeglasses for those in need.",
    category: "Eye Care",
    diagnosisType: "Eye Screening",
    about: "The Shankarnagar Eye Care Foundation is organizing a free eye checkup camp for residents of Rupandehi district. Services include complete eye examinations, vision testing, cataract screening, and glaucoma detection. Free eyeglasses will be provided to those who need them, and patients requiring surgery will be referred to partner hospitals with subsidized rates. This camp especially encourages elderly citizens and students to get their eyes checked.",
    checks: ["Vision Test", "Eye Pressure Check", "Cataract Screening", "Retina Examination", "Color Blindness Test"],
    requirements: "Valid ID proof required. Bring previous prescriptions if available.",
    serviceDetails: {
      nepaliDate: "2082-08-12",
      time: "9:00 AM - 5:00 PM",
      location: {
        address: "Shankarnagar Health Center, Ward No. 3, Shankarnagar, Rupandehi",
        type: "Point",
  ...
  },
  {
    ...
    about: "This specialized camp focuses on women's health with emphasis on cervical cancer screening. Lumbini Provincial Hospital's gynecology department offers Pap smear tests, breast examinations, and consultations on reproductive health. The camp also provides education on cancer prevention, family planning, and overall women's wellness. All services are provided with complete privacy and by female healthcare professionals.",
    checks: ["Pap Smear Test", "Breast Examination", "Pelvic Examination", "Blood Pressure Check", "Hemoglobin Test"],
    requirements: "Women aged 25-65. Valid citizenship required. Husband's consent not required.",
    serviceDetails: {
  ...
  },
  {
    ...
    description: "Consultation for bone, joint, and muscle problems with X-ray facility.",
    category: "General Health",
    diagnosisType: "Orthopedic Screening",
    about: "This orthopedic camp at Lumbini Provincial Hospital provides specialized care for patients suffering from bone, joint, and muscle problems. Experienced orthopedic surgeons will conduct consultations for conditions like arthritis, back pain, sports injuries, and fractures. X-ray facilities are available on-site for accurate diagnosis. Patients requiring surgery or advanced treatment will receive appropriate referrals and guidance on further management.",
    checks: ["Physical Examination", "Joint Mobility Test", "X-ray (if needed)", "Bone Density Screening", "Posture Assessment"],
    requirements: "All ages welcome. Bring previous medical records and X-rays if available.",
    serviceDetails: {
      nepaliDate: "2082-08-24",
      time: "9:00 AM - 4:00 PM",
      location: {
        address: "Lumbini Provincial Hospital, Orthopedic Department, Butwal, Rupandehi",
        type: "Point",
