...
export default function Footer() {
  return (
    <footer className="footer footer-center bg-base-200 text-base-content p-10 mt-20">
      <aside>
        ...
        <p className="max-w-md text-sm opacity-70">
          Providing real-time information about free government medical services, 
          health camps, and medications across Nepal.
        </p>
